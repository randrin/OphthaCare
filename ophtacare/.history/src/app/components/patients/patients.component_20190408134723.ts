...
export class PatientsComponent implements OnInit {
  ...
  submitPatient(patient: Patient) {
    console.log('Patient to register: ' + moment(this.newPatient.dateNaisPatient).format('DD/MM/YYYY'));
    patient.dateNaisPatient = moment(this.newPatient.dateNaisPatient).format('DD/MM/YYYY');
    this.newPatient = patient;
    this.blocked = true;
    console.log('Patient new: ' + this.newPatient.dateNaisPatient);
